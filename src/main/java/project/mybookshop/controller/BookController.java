...
public class BookController {
    ...
    @Operation(summary = "Delete book by id", description = "Soft delete of a book by id")
    ...
    @Operation(summary = "Search a books", description = "Get a list of books from a search by parameters")
    @GetMapping("/search")
